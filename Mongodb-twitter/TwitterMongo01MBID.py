...
def get_data_user_timeline_all_pages(kid, page):
 ...
 utilizando este método API.
        '''
        d = twitter.get_user_timeline(screen_name=kid, count="50", page=page, include_entities="true", include_rts="1")
...
dbStringConnection = "mongodb+srv://adrihp06:SRiokJqAC7XF81Wl@mbid01.tjt4y.mongodb.net/myFirstDatabase?retryWrites=true&w=majority"



dbName = 'MBID01_Twitter'
...
for s in twitter_accounts[:len(twitter_accounts)]:
    ...
    #Como no se espicifica cual twits hay que obtener, vamos a seleccionar una pagina con 200 twits
    while page < 5  :
